...
class RateLimiter {
    constructor() {
        ...
        this.limits = {
            ...
            commands: {
                calc: { maxAttempts: 3, windowMs: 5000 },      // 3 calculs par 5s
                info: { maxAttempts: 2, windowMs: 10000 },     // 2 infos par 10s
                setwelcome: { maxAttempts: 1, windowMs: 30000 } // 1 config par 30s
            }
        };
